...
export const getInitialPhases = (): Phase[] => [
    // FASE 1: PREVIA / DEFINICIÓN
    {
      ...
      checkpoints: [
        { id: "cp_1_1", title: "1.1 - Levantamiento del estado actual", status: "No iniciado", notes: "", fields: [
        ...
        { id: "cp_1_2", title: "1.2 - Análisis de patologías", status: "No iniciado", notes: "", fields: [
        ...
        { id: "cp_1_3", title: "1.3 - Análisis normativo y urbanístico", status: "No iniciado", notes: "", fields: [
        ...
        { id: "cp_1_4", title: "1.4 - Servidumbres y comunidad", status: "No iniciado", notes: "", fields: [
        ...
        { id: "cp_1_5", title: "1.5 - Estudio de viabilidad", status: "No iniciado", notes: "", fields: [
        ...
        { id: "cp_1_6", title: "1.6 - Programa de necesidades del cliente", status: "No iniciado", notes: "", fields: [
        ...
        { id: "cp_1_7", title: "1.7 - Anteproyecto validado", status: "No iniciado", notes: "", fields: [
        ...
        { id: "cp_1_8", title: "1.8 - Presupuesto objetivo aprobado", status: "No iniciado", notes: "", fields: [
    ...
    // FASE 2: PROYECTO TÉCNICO
    {
      ...
      checkpoints: [
          { id: "cp_2_1", title: "2.1 - Proyecto básico redactado", status: "No iniciado", notes: "", fields: [
          ...
          { id: "cp_2_2", title: "2.2 - Proyecto de ejecución completo", status: "No iniciado", notes: "", fields: [
          ...
          { id: "cp_2_3", title: "2.3 - Coordinación de sistemas", status: "No iniciado", notes: "", fields: [
          ...
          { id: "cp_2_4", title: "2.4 - Mediciones y pliegos", status: "No iniciado", notes: "", fields: [
              { id: generateFieldId(), label: "Mediciones realizadas", type: "checkbox", value: false, required: true },
          ...
          { id: "cp_2_5", title: "2.5 - Revisión de interferencias", status: "No iniciado", notes: "", fields: [
          ...
          { id: "cp_2_6", title: "2.6 - Documentación lista para visado", status: "No iniciado", notes: "", fields: [
          ...
          { id: "cp_2_7", title: "2.7 - Visado colegial (opcional)", status: "No iniciado", notes: "", fields: [
    ...
    // FASE 3: TRAMITACIONES Y LICENCIAS
    {
        ...
        checkpoints: [
            { id: "cp_3_1", title: "3.1 - Licencia de obra", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_3_2", title: "3.2 - Tasas e ICIO", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_3_3", title: "3.3 - Comunicaciones a terceros", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_3_4", title: "3.4 - Seguros y altas de suministros", status: "No iniciado", notes: "", fields: [
    ...
    // FASE 4: CONTRATACIÓN
    {
        ...
        checkpoints: [
            { id: "cp_4_1", title: "4.1 - Presupuesto detallado", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_4_2", title: "4.2 - Solicitud y análisis de ofertas", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_4_3", title: "4.3 - Análisis técnico-económico", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_4_4", title: "4.4 - Verificación documental de empresas", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_4_5", title: "4.5 - Contrato de obra firmado", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_4_6", title: "4.6 - Cronograma validado", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_4_7", title: "4.7 - Plan de pagos y certificaciones", status: "No iniciado", notes: "", fields: [
    ...
    // FASE 5: PREPARACIÓN DE OBRA
    {
        ...
        checkpoints: [
            { id: "cp_5_1", title: "5.1 - Replanteo topográfico", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_5_2", title: "5.2 - Plan de Seguridad y Salud", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_5_3", title: "5.3 - Organización de obra", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_5_4", title: "5.4 - Libros de registro habilitados", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_5_5", title: "5.5 - Acta de replanteo y comienzo", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_5_6", title: "5.6 - Pedidos iniciales", status: "No iniciado", notes: "", fields: [
    ...
    // FASE 6: EJECUCIÓN - ESTRUCTURA
    {
        ...
        checkpoints: [
            { id: "cp_6_1", title: "6.1 - Demoliciones y desmontajes", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_6_2", title: "6.2 - Movimientos de tierra", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_6_3", title: "6.3 - Cimentación", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_6_4", title: "6.4 - Estructura", status: "No iniciado", notes: "", fields: [
    ...
    // FASE 7: EJECUCIÓN - CERRAMIENTOS Y CUBIERTAS
    {
        ...
        checkpoints: [
            { id: "cp_7_1", title: "7.1 - Fábricas y cerramientos", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_7_2", title: "7.2 - Aislamientos", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_7_3", title: "7.3 - Carpinterías exteriores", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_7_4", title: "7.4 - Cubiertas", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_7_5", title: "7.5 - Recogidas de aguas", status: "No iniciado", notes: "", fields: [
    ...
    // FASE 8: EJECUCIÓN - PARTICIONES INTERIORES
    {
        ...
        checkpoints: [
            { id: "cp_8_1", title: "8.1 - Tabiquería", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_8_2", title: "8.2 - Trasdosados", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_8_3", title: "8.3 - Falsos techos", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_8_4", title: "8.4 - Revestimientos base", status: "No iniciado", notes: "", fields: [
    ...
    // FASE 9: INSTALACIONES
    {
        ...
        checkpoints: [
            { id: "cp_9_1", title: "9.1 - Fontanería", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_9_2", title: "9.2 - Saneamiento", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_9_3", title: "9.3 - Electricidad", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_9_4", title: "9.4 - Climatización y ventilación", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_9_5", title: "9.5 - Telecomunicaciones", status: "No iniciado", notes: "", fields: [
                { id: generateFieldId(), label: "Canalizaciones completadas", type: "checkbox", value: false, required: true },
    ...
    // FASE 10: ACABADOS Y REMATES
    {
        ...
        checkpoints: [
            { id: "cp_10_1", title: "10.1 - Alicatados y solados", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_10_2", title: "10.2 - Carpintería interior", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_10_3", title: "10.3 - Pintura final", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_10_4", title: "10.4 - Montaje de aparatos", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_10_5", title: "10.5 - Limpieza final", status: "No iniciado", notes: "", fields: [
    ...
    // FASE 11: CIERRE DE OBRA
    {
        ...
        checkpoints: [
            { id: "cp_11_1", title: "11.1 - Pruebas finales de instalaciones", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_11_2", title: "11.2 - Documentación técnica final", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_11_3", title: "11.3 - Trámites municipales de cierre", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_11_4", title: "11.4 - Liquidación económica", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_11_5", title: "11.5 - Acta de recepción", status: "No iniciado", notes: "", fields: [
    ...
    // FASE 12: POST-OBRA (Seguimiento)
    {
        ...
        checkpoints: [
            { id: "cp_12_1", title: "12.1 - Vigilancia inicial (primeras semanas)", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_12_2", title: "12.2 - Revisión a 3 meses", status: "No iniciado", notes: "", fields: [
            ...
            { id: "cp_12_3", title: "12.3 - Revisión a 12 meses", status: "No iniciado", notes: "", fields: [
                { id: generateFieldId(), label: "Revisión completada", type: "checkbox", value: false, required: true },
                { id: generateFieldId(), label: "Fecha de revisión", type: "date", value: null, required: true },
                { id: generateFieldId(), label: "Obra en garantía aceptada", type: "checkbox", value: false, required: true },
                { id: generateFieldId(), label: "Acta de revisión adjuntada", type: "checkbox", value: false, required: false },
            ]},
            { id: "cp_12_4", title: "12.4 - Gestión de incidencias en garantía", status: "No iniciado", notes: "", fields: [
